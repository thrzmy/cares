    ...
    <div class="print-container">
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; margin-bottom: 20px;">
            <div style="border: 1px solid #ddd; padding: 10px; border-radius: 4px; text-align: center;">
                <div style="font-size: 7.5pt; text-transform: uppercase; color: #666;">Apply Count</div>
            ...
            <div style="border: 1px solid #ddd; padding: 10px; border-radius: 4px; text-align: center;">
                ...
                <div style="font-size: 14pt; font-weight: 700;"><?= e((string)($summary['score_entries'] / max(1, count($examParts)) ?? 0)) ?></div>
            </div>
            <div style="border: 1px solid #ddd; padding: 10px; border-radius: 4px; text-align: center;">
            ...
            <div style="border: 1px solid #ddd; padding: 10px; border-radius: 4px; text-align: center;">
                <div style="font-size: 7.5pt; text-transform: uppercase; color: #666;">Evaluation Entry</div>
            ...
            <div class="signature-block">
                ...
                <div style="font-weight: 600;">
                    <?php
                         ...
                         $currentUser = $sigStmt->fetchColumn() ?: 'Authorized Signatory';
                         echo e($currentUser);
                    ?>
                </div>
                <div class="text-muted" style="font-size: 8pt;">Administrator / Prepared By</div>
            </div>
