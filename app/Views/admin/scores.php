  ...
  <?php if ($recordScopeFilter === 'archived'): ?>
    <div class="row g-2 align-items-end mt-1">
      <div class="col-12 col-md-6">
        ...
        <select class="form-select" id="archivedRecoSchoolYearFilter" name="school_year_id">
      ...
      <div class="col-12 col-md-6">
        ...
        <select class="form-select" id="archivedRecoSemesterFilter" name="semester_id">
    ...
    <div class="col-12">
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-stretch align-items-md-center gap-2">
        ...
        <div class="d-grid d-md-flex gap-2 justify-content-md-end">
          <a class="btn btn-outline-secondary" href="<?= e(BASE_PATH) ?>/administrator/scores<?= $recordScopeFilter !== 'active' ? '?record_scope=' . urlencode($recordScopeFilter) : '' ?>">Clear Filters</a>
...
<?php if ($recordScopeFilter === 'archived'): ?>
  <script>
    (() => {
      const schoolYearSelect = document.getElementById('archivedRecoSchoolYearFilter');
      const semesterSelect = document.getElementById('archivedRecoSemesterFilter');
