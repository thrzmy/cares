...
<div class="card shadow-sm">
  <div class="card-body">
    ...
    <p class="text-muted mb-3">Encode test results, manage storage, and review recommendations.</p>

    <div class="row g-3">
      <div class="col-12 col-md-6">
        <div class="border rounded p-3 bg-white">
          <h6 class="fw-bold mb-1">Encode Test Results</h6>
          <p class="text-muted small mb-2">Record exam part scores for students.</p>
      ...
      <div class="col-12 col-md-6">
        <div class="border rounded p-3 bg-white">
          ...
          <p class="text-muted small mb-2">Course recommendation rankings.</p>
