...
<head>
    ...
    <title><?= e(APP_NAME) ?> - 419 Session Expired</title>
    <style>
        body {
            margin: 0;
            min-height: 100vh;
...
<body>
    <div class="error-card">
        ...
        <p>Your session expired or the submitted form is no longer valid. Please go back and try again.</p>
        <div class="actions">
            <a class="btn btn-primary" href="javascript:history.back()">Go Back</a>
            <a class="btn btn-secondary" href="<?= e(BASE_PATH) ?>/login">Go to Login</a>
        </div>
    </div>
</body>
</html>
