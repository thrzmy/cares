...
<body>
    <div class="error-card">
        ...
        <div class="kicker">403 Forbidden</div>
        <h1>Access denied</h1>
        <p>You do not have permission to open this page. Please sign in with the correct account or go back to a page you can access.</p>
        <div class="actions">
