...
CREATE TABLE students (
    ...
    shs_strand VARCHAR(100) NULL,
    gpa DECIMAL(5,2) NULL,
    physical_requirement_status ENUM('pending', 'met', 'not_met') NOT NULL DEFAULT 'pending',
    honors_awards_points DECIMAL(5,2) NULL,
    residence_points DECIMAL(5,2) NULL,
    other_screening_points DECIMAL(5,2) NULL,
    cct_choice ENUM('first', 'second', 'none') NOT NULL DEFAULT 'first',
    first_choice INT UNSIGNED NULL,
    second_choice INT UNSIGNED NULL,
    application_status ENUM('new_student', 'transferee', 'returning_student', 'adult_learner', 'old_curriculum', 'als_passer') NOT NULL DEFAULT 'new_student',
    screening_status ENUM('pending', 'qualified', 'not_qualified') NOT NULL DEFAULT 'pending',
    ...
    updated_at TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    deleted_at DATETIME NULL,
    UNIQUE KEY uk_students_application_number (application_number),
    INDEX idx_students_name_parts (last_name, first_name),
    INDEX idx_students_application_status (application_status),
    INDEX idx_students_screening_status (screening_status),
    INDEX idx_students_status (status),
    INDEX idx_students_first_choice (first_choice),
    INDEX idx_students_second_choice (second_choice),
...
CREATE TABLE courses (
    ...
    course_category VARCHAR(150) NOT NULL,
    is_deleted TINYINT(1) NOT NULL DEFAULT 0,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
    deleted_at DATETIME NULL,
    UNIQUE KEY uk_courses_code (course_code),
    INDEX idx_courses_category (course_category),
